...
@section('main')
    ...
    <div class="flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
        ...
        <div>
            <span class="font-medium">¡Genial!</span> Haz creado un nuevo administrador.
        </div>
    </div>
    @endif
    @if($errors->any())
                    ...
                    <div class="w-full">
                        <form action="{{ route('create.admin') }}" method="post">
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input type="password" class="block w-full mt-1 text-sm @error('password') border-red-800 shadow-outline-red @enderror dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="password" placeholder="********" x-bind:type="isShowPassword" />
                            </label>
                            <label class="block mt-4 text-sm">
                                <span class="text-gray-700 dark:text-gray-400">
                                    <svg class="w-4 h-4 inline" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                                ...
                                <input type="password" class="block w-full mt-1 text-sm @error('password') border-red-800 shadow-outline-red @enderror dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="********" x-bind:type="isShowPassword" />
                            </label>
