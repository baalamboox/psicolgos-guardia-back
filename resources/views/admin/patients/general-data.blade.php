...
@section('main')
        ...
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img src="https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f" alt="⚠️ Error de carga" class="object-cover w-full h-full" aria-hidden="true" />
                </div>
                    ...
                    <div class="w-full">
                        ...
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
                                ...
                                Fecha de nacimiento : 23/12/1999
                            </span>
                        </label>
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
                        ...
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
                                ...
                                Correo electrónico : ferna@gmail.com
                            </span>
                        </label>
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
                                ...
                                Dirección : Callejon Las Flore, Milpa Alta, 12100, CDMX
                            </span>
                        </label>
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
    ...
    <div class="min-w-0 p-8 bg-white rounded-lg shadow-xs dark:bg-gray-800"">
        <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-6">
                <span class="flex items-center justify-center w-8 h-8 bg-blue-100 rounded-full text-blue-800 my-4 dark:text-white dark:bg-blue-900">
                ...
                <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
                    ...
                    <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2 py-1 rounded-full dark:bg-blue-900 dark:text-blue-300 ml-3">Último</span>
                </h3>
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">20/10/2023</time>
                <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Se detecto que ingresaste de formar correcta a tu cuenta de administrador.
                </p>
            </li>
            <li class="mb-10 ml-6">
                <span class="flex items-center justify-center w-8 h-8 bg-blue-100 rounded-full text-blue-800 my-4 dark:text-white dark:bg-blue-900">
                ...
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">19/10/2023</time>
                <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Se detecto que ingresaste de formar correcta a tu cuenta de administrador.
                </p>
            </li>
            <li class="mb-10 ml-6">
                ...
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">18/10/2023</time>
                <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Se detecto que ingresaste de formar correcta a tu cuenta de administrador.
                </p>
            </li>
            <li class="mb-10 ml-6">
                ...
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">16/10/2023</time>
                <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Se detecto que ingresaste de formar correcta a tu cuenta de administrador.
                </p>
            </li>
