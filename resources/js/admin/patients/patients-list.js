...
const generalData = ({href}) => html(`
    <a href="${href}" class="flex text-xs gap-1 align-middle p-1 rounded w-20 mx-auto justify-center border border-gray-100 bg-gray-100 text-gray-400 hover:border-gray-200 hover:bg-gray-200 hover:text-gray-600">
...
`);
const status = ({state}) => state === '1' ? html(`
    <a class="flex text-xs gap-1 p-1 align-middle rounded w-25 mx-auto justify-center text-green-600 bg-green-200">
        <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
...
`) : html(`
    <a class="flex text-xs gap-1 p-1 align-middle rounded w-25 mx-auto justify-center text-red-600 bg-red-200">
        <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
